(function() {
  var Fiber, Future, base, defineMemoizedPerInstanceProperty, fibrous, functionWithFiberReturningFuture, futureize, key, objectPrototypeProps, proxyAll, proxyBuilder, synchronize, _i, _j, _len, _len2, _ref, _ref2,
  ...
  proxyAll = function(src, target, proxyFn) {
    ...
    _fn = function(key) {
      if (objectPrototypeProps[key]) return;
      if (Object.getOwnPropertyDescriptor(src, key).get != null) return;
