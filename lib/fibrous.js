...
(function() {
  var Fiber, Future, base, defineMemoizedPerInstanceProperty, fibrous, functionWithFiberReturningFuture, futureize, key, objectPrototypeProps, proxyAll, proxyBuilder, synchronize, _i, _j, _len, _len1, _ref, _ref1,
    __slice = [].slice;
  ...
  proxyAll = function(src, target, proxyFn) {
    ...
    _ref1 = Object.keys(src);
    _fn = function(key) {
      if (objectPrototypeProps[key]) {
        return;
      }
  ...
  _ref1 = [Object.prototype, Function.prototype];
  for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
    base = _ref1[_j];
  ...
  fibrous.wait = function() {
    ...
    getResults = function(futureOrArray) {
      var i, _k, _len2, _results;
      if (futureOrArray instanceof Future) {
        return futureOrArray.get();
      }
      _results = [];
      for (_k = 0, _len2 = futureOrArray.length; _k < _len2; _k++) {
        i = futureOrArray[_k];
