...
(function() {
  var Fiber, Future, base, defineMemoizedPerInstanceProperty, fibrous, functionWithFiberReturningFuture, futureize, proxyAll, proxyBuilder, skipProps, synchronize, _i, _len, _ref,
    __slice = [].slice;
  ...
  proxyAll = function(src, target, proxyFn) {
    ...
    _ref = Object.getOwnPropertyNames(src);
    _fn = function(key) {
