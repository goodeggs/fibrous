// CodeClimate: don't ignore CoffeeScript 1.9.1
(function() {
  var Fiber, Future, base, defineMemoizedPerInstanceProperty, fibrous, functionWithFiberReturningFuture, futureize, j, len, proxyAll, proxyBuilder, ref, synchronize,
    slice = [].slice;
